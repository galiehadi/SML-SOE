...
$fileRep = 'amg_master'.((float)$usec + (float)$sec);
$fileRep = str_replace(".","",$fileRep);
$inputFileName = $fileRep.'.xlsm';
copy("amg_master.xlsm",'processed_files\\'.$inputFileName);
...
$turbine_5_dry_step_efficiency_value = round($spreadsheet->getSheetByName('output')->getCell('G30')->getCalculatedValue(),2);
$turbine_5_dry_step_efficiency_unit = $spreadsheet->getSheetByName('output')->getCell('E30')->getCalculatedValue();
$turbine_6_dry_step_efficiency_value = round($spreadsheet->getSheetByName('output')->getCell('G31')->getCalculatedValue(),2);
$turbine_6_dry_step_efficiency_unit = $spreadsheet->getSheetByName('output')->getCell('E31')->getCalculatedValue();
$turbine_7_dry_step_efficiency_value = round($spreadsheet->getSheetByName('output')->getCell('G32')->getCalculatedValue(),2);
$turbine_7_dry_step_efficiency_unit = $spreadsheet->getSheetByName('output')->getCell('E32')->getCalculatedValue();
$turbine_efficiency_value = round($spreadsheet->getSheetByName('output')->getCell('G33')->getCalculatedValue(),2);
$turbine_efficiency_unit = $spreadsheet->getSheetByName('output')->getCell('E33')->getCalculatedValue();

$hph_1_dca_value = round($spreadsheet->getSheetByName('output')->getCell('G35')->getCalculatedValue(),2);
$hph_1_dca_unit = $spreadsheet->getSheetByName('output')->getCell('E35')->getCalculatedValue();
$hph_1_ttd_value = round($spreadsheet->getSheetByName('output')->getCell('G36')->getCalculatedValue(),2);
$hph_1_ttd_unit = $spreadsheet->getSheetByName('output')->getCell('E36')->getCalculatedValue();
$hph_2_dca_value = round($spreadsheet->getSheetByName('output')->getCell('G37')->getCalculatedValue(),2);
$hph_2_dca_unit = $spreadsheet->getSheetByName('output')->getCell('E37')->getCalculatedValue();
$hph_2_ttd_value = round($spreadsheet->getSheetByName('output')->getCell('G38')->getCalculatedValue(),2);
$hph_2_ttd_unit = $spreadsheet->getSheetByName('output')->getCell('E38')->getCalculatedValue();
$lph_4_dca_value = round($spreadsheet->getSheetByName('output')->getCell('G39')->getCalculatedValue(),2);
$lph_4_dca_unit = $spreadsheet->getSheetByName('output')->getCell('E39')->getCalculatedValue();
$lph_4_ttd_value = round($spreadsheet->getSheetByName('output')->getCell('G40')->getCalculatedValue(),2);
$lph_4_ttd_unit = $spreadsheet->getSheetByName('output')->getCell('E40')->getCalculatedValue();
$lph_5_dca_value = round($spreadsheet->getSheetByName('output')->getCell('G41')->getCalculatedValue(),2);
$lph_5_dca_unit = $spreadsheet->getSheetByName('output')->getCell('E41')->getCalculatedValue();
$lph_5_ttd_value = round($spreadsheet->getSheetByName('output')->getCell('G42')->getCalculatedValue(),2);
$lph_5_ttd_unit = $spreadsheet->getSheetByName('output')->getCell('E42')->getCalculatedValue();
$lph_6_dca_value = round($spreadsheet->getSheetByName('output')->getCell('G43')->getCalculatedValue(),2);
$lph_6_dca_unit = $spreadsheet->getSheetByName('output')->getCell('E43')->getCalculatedValue();
$lph_6_ttd_value = round($spreadsheet->getSheetByName('output')->getCell('G44')->getCalculatedValue(),2);
$lph_6_ttd_unit = $spreadsheet->getSheetByName('output')->getCell('E44')->getCalculatedValue();
$_value = round($spreadsheet->getSheetByName('output')->getCell('G45')->getCalculatedValue(),2);
$_unit = $spreadsheet->getSheetByName('output')->getCell('E45')->getCalculatedValue();

$gross_output_value = round($spreadsheet->getSheetByName('output')->getCell('G47')->getCalculatedValue(),2);
$gross_output_unit = $spreadsheet->getSheetByName('output')->getCell('E47')->getCalculatedValue();
$gross_heat_rate_hhv_value = round($spreadsheet->getSheetByName('output')->getCell('G48')->getCalculatedValue(),2);
$gross_heat_rate_hhv_unit = $spreadsheet->getSheetByName('output')->getCell('E48')->getCalculatedValue();
$nett_output_value = round($spreadsheet->getSheetByName('output')->getCell('G49')->getCalculatedValue(),2);
$nett_output_unit = $spreadsheet->getSheetByName('output')->getCell('E49')->getCalculatedValue();
$nett_heat_rate_hhv_value = round($spreadsheet->getSheetByName('output')->getCell('G50')->getCalculatedValue(),2);
$nett_heat_rate_hhv_unit = $spreadsheet->getSheetByName('output')->getCell('E50')->getCalculatedValue();


$gross_heat_rate_lhv_value = round($spreadsheet->getSheetByName('output')->getCell('G53')->getCalculatedValue(),2);
$gross_heat_rate_lhv_unit = $spreadsheet->getSheetByName('output')->getCell('E53')->getCalculatedValue();
$hhv_value = round($spreadsheet->getSheetByName('output')->getCell('G54')->getCalculatedValue(),2);
$hhv_unit = $spreadsheet->getSheetByName('output')->getCell('E54')->getCalculatedValue();
$lhv_value = round($spreadsheet->getSheetByName('output')->getCell('G55')->getCalculatedValue(),2);
$lhv_unit = $spreadsheet->getSheetByName('output')->getCell('E55')->getCalculatedValue();


//interface
$json_subdata_int['gross_power_output']['value'] = round($spreadsheet->getSheetByName('output')->getCell('G47')->getCalculatedValue(),2);
$json_subdata_int['gross_power_output']['unit'] = $spreadsheet->getSheetByName('output')->getCell('E47')->getCalculatedValue();

// print_r('gross heat rate ',round($spreadsheet->getSheetByName('output')->getCell('G39')->getCalculatedValue(),2));

$json_subdata_int['gross_heatrate']['value'] = round($spreadsheet->getSheetByName('output')->getCell('G51')->getCalculatedValue(),2);
$json_subdata_int['gross_heatrate']['unit'] = $spreadsheet->getSheetByName('output')->getCell('E48')->getCalculatedValue();
$json_subdata_int['net_output']['value'] = round($spreadsheet->getSheetByName('output')->getCell('G49')->getCalculatedValue(),2);
$json_subdata_int['net_output']['unit'] = $spreadsheet->getSheetByName('output')->getCell('E49')->getCalculatedValue();
$json_subdata_int['net_heatrate']['value'] = round($spreadsheet->getSheetByName('output')->getCell('G50')->getCalculatedValue(),2);
$json_subdata_int['net_heatrate']['unit'] = $spreadsheet->getSheetByName('output')->getCell('E50')->getCalculatedValue();
...
$json_subdata_26['name'] = 'HPH-1 DCA';
$json_subdata_26['unit'] = $hph_1_dca_unit;
$json_subdata_26['value'] = $hph_1_dca_value;
$json_subdata_27['name'] = 'HPH-1 TTD';
$json_subdata_27['unit'] = $hph_1_ttd_unit;
$json_subdata_27['value'] = $hph_1_ttd_value;
$json_subdata_28['name'] = 'HPH-2 DCA';
$json_subdata_28['unit'] = $hph_2_dca_unit;
$json_subdata_28['value'] = $hph_2_dca_value;
$json_subdata_29['name'] = 'HPH-2 TTD';
$json_subdata_29['unit'] = $hph_2_ttd_unit;
$json_subdata_29['value'] = $hph_2_ttd_value;
$json_subdata_30['name'] = 'LPH-4 DCA';
$json_subdata_30['unit'] = $lph_4_dca_unit;
$json_subdata_30['value'] = $lph_4_dca_value;
$json_subdata_31['name'] = 'LPH-4 TTD';
$json_subdata_31['unit'] = $lph_4_ttd_unit;
$json_subdata_31['value'] = $lph_4_ttd_value;
$json_subdata_32['name'] = 'LPH-5 DCA';
$json_subdata_32['unit'] = $lph_5_dca_unit;
$json_subdata_32['value'] = $lph_5_dca_value;
$json_subdata_33['name'] = 'LPH-5 TTD';
$json_subdata_33['unit'] = $lph_5_ttd_unit;
$json_subdata_33['value'] = $lph_5_ttd_value;
$json_subdata_34['name'] = 'LPH-6 DCA';
$json_subdata_34['unit'] = $lph_6_dca_unit;
$json_subdata_34['value'] = $lph_6_dca_value;
$json_subdata_35['name'] = 'LPH-6 TTD';
$json_subdata_35['unit'] = $lph_6_ttd_unit;
$json_subdata_35['value'] = $lph_6_ttd_value;


$json_subdata_36['name'] = 'Gross Output';
$json_subdata_36['unit'] = $gross_output_unit;
$json_subdata_36['value'] = $gross_output_value;
$json_subdata_37['name'] = 'Gross Heat Rate (HHV)';
$json_subdata_37['unit'] = $gross_heat_rate_hhv_unit;
$json_subdata_37['value'] = $gross_heat_rate_hhv_value;
$json_subdata_38['name'] = 'Nett Output';
$json_subdata_38['unit'] = $nett_output_unit;
$json_subdata_38['value'] = $nett_output_value;
$json_subdata_39['name'] = 'Nett Heat Rate (HHV)';
$json_subdata_39['unit'] = $nett_heat_rate_hhv_unit;
$json_subdata_39['value'] = $nett_heat_rate_hhv_value;


$json_subdata_40['name'] = 'Gross Heat Rate (LHV)';
$json_subdata_40['unit'] = $gross_heat_rate_lhv_unit;
$json_subdata_40['value'] = $gross_heat_rate_lhv_value;
$json_subdata_41['name'] = 'HHV';
$json_subdata_41['unit'] = $hhv_unit;
$json_subdata_41['value'] = $hhv_value;
$json_subdata_42['name'] = 'LHV';
$json_subdata_42['unit'] = $lhv_unit;
$json_subdata_42['value'] = $lhv_value;
...
$json_draw_26['id'] = 'D26';
$json_draw_26['value'] = $hph_1_dca_value. ' '. $hph_1_dca_unit;
$json_draw_27['id'] = 'D27';
$json_draw_27['value'] = $hph_1_ttd_value. ' '. $hph_1_ttd_unit;
$json_draw_28['id'] = 'D28';
$json_draw_28['value'] = $hph_2_dca_value. ' '. $hph_2_dca_unit;
$json_draw_29['id'] = 'D29';
$json_draw_29['value'] = $hph_2_ttd_value. ' '. $hph_2_ttd_unit;
$json_draw_30['id'] = 'D30';
$json_draw_30['value'] = $lph_4_dca_value. ' '. $lph_4_dca_unit;
$json_draw_31['id'] = 'D31';
$json_draw_31['value'] = $lph_4_ttd_value. ' '. $lph_4_ttd_unit;
$json_draw_32['id'] = 'D32';
$json_draw_32['value'] = $lph_5_dca_value. ' '. $lph_5_dca_unit;
$json_draw_33['id'] = 'D33';
$json_draw_33['value'] = $lph_5_ttd_value. ' '. $lph_5_ttd_unit;
$json_draw_34['id'] = 'D34';
$json_draw_34['value'] = $lph_6_dca_value. ' '. $lph_6_dca_unit;
$json_draw_35['id'] = 'D35';
$json_draw_35['value'] = $lph_6_ttd_value. ' '. $lph_6_ttd_unit;


$json_draw_36['id'] = 'D36';
$json_draw_36['value'] = $gross_output_value. ' '. $gross_output_unit;
$json_draw_37['id'] = 'D37';
$json_draw_37['value'] = $gross_heat_rate_hhv_value. ' '. $gross_heat_rate_hhv_unit;
$json_draw_38['id'] = 'D38';
$json_draw_38['value'] = $nett_output_value. ' '. $nett_output_unit;
$json_draw_39['id'] = 'D39';
$json_draw_39['value'] = $nett_heat_rate_hhv_value. ' '. $nett_heat_rate_hhv_unit;


$json_draw_40['id'] = 'D40';
$json_draw_40['value'] = $gross_heat_rate_lhv_value. ' '. $gross_heat_rate_lhv_unit;
$json_draw_41['id'] = 'D41';
$json_draw_41['value'] = $hhv_value. ' '. $hhv_unit;
$json_draw_42['id'] = 'D42';
$json_draw_42['value'] = $lhv_value. ' '. $lhv_unit;
